...
app.post('/update-contact-number', upload.single('image'), async (req, res) => {
    ...
    try {
      await updateContactNumber(imagePath, newNumber, textColor, backgroundColor, parseInt(startX), parseInt(startY), parseInt(endX), parseInt(endY), outputPath);
  ...
  async function updateContactNumber(imagePath, newNumber, textColor, backgroundColor, startX, startY, endX, endY, outputPath) {
